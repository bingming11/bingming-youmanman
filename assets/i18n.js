...
window.I18N = {
  "zh": {
    ...
    "calc.hei": "高 (cm)",
    "calc.go": "计算预估运费",
    "calc.note": "体积重 = 长×宽×高 ÷ 6000；计费重 = max(实重, 体积重)，并按线路最低计费重封底。结果随报价表更新，仅供参考。",
  ...
  "en": {
    ...
    "calc.note": "Volumetric weight = L×W×H ÷ 6000; chargeable weight = max(actual, volumetric), floored by the route's minimum. Updates with the quote table; for reference only.",
  ...
  "ko": {
    ...
    "calc.hei": "높이 (cm)",
    "calc.go": "예상 배송비 계산",
    "calc.note": "부피중량 = 가로×세로×높이 ÷ 6000; 과금중량 = max(실중량, 부피중량)이며 노선 최소 과금중량으로 하한 적용. 견적표 업데이트에 따라 변동되며 참고용입니다.",
